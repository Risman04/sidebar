...
<body>
    <div class="card w-50" style="margin:  2rem 30rem ">
        <div class="card-header">
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="cek_ticket.html">Support Center Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="create.html">Open a New Ticket</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="support.html">Check Ticket Status</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                @csrf
                <h2 style="color:rgb(0, 183, 255)">Account Registration</h2>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <b>Email Address<strong style="color:red">*</strong></b>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="input-group mb-3">
                                ...
                                <input id="email" type="email" class="form-control" name="email" placeholder="Masukan Email" required>
                              </div>
                        </td>
                    </tr>
                    <tr>
                        <td><b>Full Name<strong style="color:red">*</strong></b></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="input-group mb-3">
                                ...
                                <input id="name" type="text" class="form-control" name="name" placeholder="Masukan Nama" required>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <div class="input-group mb-3">
                                ...
                                <input id="phone" type="number" class="form-control" name="phone" placeholder="Masukan Nomor HP">
                            </div>
                        </td>
                    </tr>
                </table>
